    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="border-2 border-border rounded-lg p-8 bg-card">
          ...
          <div className="text-[10px] text-foreground space-y-3 leading-relaxed">
            <div>
            ...
            <div>
              ...
              <p>
                A DEFENSIVE technique will always describe the exact type of technique it blocks. If a DEFENSIVE technique has less Priority than an OFFENSIVE one, it still blocks it. But if the attacking player has more Energy after using their attack, the DEFENSIVE technique loses. For example:
              </p>
              <p>
                Great Shield (4 Priority): Block any PHYSICAL MELEE.
              </p>
              <p>
                Great Shield will lose against any PHYSICAL MELEE with double its Priority (8+)
              </p>
              <p>
                Normally, Great Shield will win against any PHYSICAL MELEE attack with 4-7 Priority.
              </p>
              <p>
                Great Shield will win against any PHYSICAL MELEE with 4-7 Priority BUT loses if the attacker has more Energy.
              </p>
              <p>
              ...
              <p>
                Great Shield: Block any PHYSICAL MELEE with 5 or less Priority.
              </p>
              <p>
                Great Shield will lose against any PHYSICAL MELEE that has 6+ Priority.
              </p>
              <p>
                Great Shield will win against any PHYSICAL MELEE that has 5 or less Priority.
              </p>
              <p>
